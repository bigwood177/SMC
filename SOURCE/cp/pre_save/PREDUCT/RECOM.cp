...
NXTREC,
	...
	IF (PRDSTR.EQ.']]]]]]]]') RETURN	;RETURN TO LINCN, NO MORE
						;RECORDS TO PROCESS
	IF (PITMNO.LT.LITMNO) GOTO NXTREC
	IF (PITMNO.GT.LITMNO) RETURN		;RETURN TO LINCN
...
BADMSG,
	IF (BADBIL.EQ.1) RETURN		;GO BACK TO LINCN AND DON'T ALLOW
...
NEWCMP,
	...
	IF (STOKED.NE.'S') RETURN		;KEEP GOING TILL WE REACH
						;A STOCKED LEVEL
	IF (CNTRLD.NE.'C') RETURN		;LEAVE COMMITTED UNADJUSTED
...
TOTQTY,
	...
	IF (DECML2.GT.0.AND.DECML2.LT.+5000) DECML2 = DECML2 + 10000
	IF (DECML2.LT.0.AND.DECML2.GT.-5000) DECML2 = DECML2 - 10000
	DECML2 = ((DECML2)#4) * 10000
		;ROUND QTYPER, BUT ASSURE THAT ANYTHING BETWEEN 1 AND -1
		;END UP AS BEING 1 OR -1 INSTEAD OF ZERO.
	LOCCTR =
FNDSTK,
	...
	IF (BADBIL.NE.1) QTYCOM(LOCCTR) = QTYCOM(LOCCTR) - (DECML2/10000)
	IF (BADBIL.EQ.1) QTYCOM(LOCCTR) = QTYCOM(LOCCTR) - (DECMAL/10000)
	IF (BADBIL.EQ.1) QTYCOM(LOCCTR) = QTYCOM(LOCCTR) + (DECML2/10000)
