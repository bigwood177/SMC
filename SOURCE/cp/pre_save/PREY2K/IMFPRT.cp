...
;;;	XCALL OUTPT (6,25,0,'1. BASE ITEM MASTER DATA',V)
;;;	XCALL OUTPT (7,25,0,'2. INVENTORY MANAGEMENT DATA',V)
;;;	XCALL OUTPT (8,25,0,'3. MANUFACTURING DATA',V)
;;;	XCALL OUTPT (9,25,0,'4. ALL DATA',V)
;;;	XCALL INPUT (5,42,01,01,'#E',ENTRY,INXCTL,V)
;;;	GO TO (END), INXCTL - 1
;;;	SELECT = ENTRY
;;;	GO TO (BEGIN,MGMNT,MNFAC,ALDATA), SELECT
;;;	GO TO END
;;;MGMNT,
;;;	XCALL PGCHN ('CP:IMFPR2',1)
;;;MNFAC,
;;;	XCALL PGCHN ('CP:IMFPR3',1)
;;;ALDATA,
;;;	XCALL PGCHN ('CP:IMFPR4',1)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
