...
PROC
	XCALL TERID (V)
	SWITCH = 1
	XCALL FILES (2,'I',41,SWITCH)		;FILE # 41 -- ITMMAS FILE
...
;;;	LOKCTL = 1
;;;	XCALL IO (9,SHVCTL,1,READ,LOKCTL)
;;;	ORGSHV = ORG172
...
;;;	S_VIA = ENTRY(1,1)
;;;	IF (S_VIA .EQ. ' ') GOTO S_VIA
;;;	SRCCTL = 2
;;;	BSEND = ORGSHV
;;;	XCALL SERCH (9,SHPVIA,S_VIA,1,1,ORGSHV,BSMID,SRCCTL,4,2,7,0,0,0,0)
;;;	IF (SRCCTL)
;;;		BEGIN
;;;		XCALL MESAG ('SHIP VIA CODE NOT IN TABLE',1)
;;;		GOTO S_VIA
;;;		END
;;;	XCALL OUTPT (11,29,0,SHPVDS,1)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;BEG2,
;;;	XCALL OUTPT (16,20,0,'<E>STIMATES OR <O>RDERS <O> ? ',1)
;;;	XCALL INPUT (16,50,1,0,'A ',ENTRY,INXCTL,1)
;;;	GOTO (GETOUT), INXCTL
;;;	ORDEST = ENTRY
;;;	IF (ORDEST.NE.'O'.AND.ORDEST.NE.'E') GOTO BEG2
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
SETORD,
	IF (OSCAC .NE. X_SCAC) GOTO RDHDR	;SSQ 09-12-97
	PAGENO = 1
	SHIPTO (1) = OSHPNM
	SHIPTO (2) = OSHAD1
	SHIPTO (3) = OSHAD2
