...
ASK2,
	XCALL OUTPT (12,20,0,'ORDER DT (YYMMDD)    ST:          END:       ',1)
	XCALL INPUT (12,45,06,00,'# ',ENTRY,INXCTL,1)
	GOTO (ASK), INXCTL
	STORDR = ENTRY
	IF (STORDR.EQ.0) XCALL OUTPT (12,45,0,'FIRST ',1)
	XCALL INPUT (12,59,06,00,'# ',ENTRY,INXCTL,1)
	GOTO (ASK), INXCTL
	ENORDR = ENTRY
	IF (ENORDR.EQ.0) 
	BEGIN
...
;	XCALL FILES (4,'I',177,4)
	...
	SORT (INPUT=FILNAM,RECORD=ORDHDR,KEY=(OSLMAN/A,OKEYDT/A,OORDNO/A))
...
;	END
	...
	PLINE (35,64) = OCUSNM
	PLINE (68,77) = OPONO
	IF (OPROMD(1,4).NE.0) PLINE (81,88) = OPROMD, DTMASK
	PLINE (92,93) = OLOC
